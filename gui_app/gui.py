...
class PageOne(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        self.label = ttk.Label(self, image=self.tk_img)
        self.label.image = self.tk_img  # Keep a reference to avoid garbage collection
    ...
    def generate_qr_code(self):
        # Combine IP and port into a string (send this to Java)
